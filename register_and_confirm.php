...
(  (!empty($_GET["q"]))
&& (is_string($_GET["q"]))
&& (!empty($_SESSION['glob_mail_var']))
&& (is_string($_SESSION['glob_mail_var']))
)
{
    ...
    $email_address = strtolower($_SESSION['glob_mail_var']);
...
)
{
    ...
    if (!check_valid_email($_SESSION['glob_mail_var'])) die("SORRY - THE EMAIL ADDRESS IS NOT USABLE");

    // NORMALIZE THE EMAIL ADDRESS
    $email_address = trim($_SESSION['glob_mail_var']);
